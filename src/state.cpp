/**
 * @file state.cpp
 * @brief Definicje zmiennych globalnych - Trassar-Painter v7.0.0
 */

#include "state.h"

// ISR FLAGS - v7.0.0: flag_btnStartPause zamiast osobnych
volatile bool flag_btnStartPause = false;
...
// CYKLOWANIE WZORCA (v7.0.0)
PatternCycleState patternCycle = {0.0f, true};

// PRĘDKOŚĆ WYSTARCZAJĄCA (v7.0.0)
